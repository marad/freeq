(defproject freeq "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "freeq.core/on-figwheel-reload"}

                :compiler {:main freeq.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/freeq.js"
